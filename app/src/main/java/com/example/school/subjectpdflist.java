...
public class subjectpdflist extends AppCompatActivity {

    EditText edit,editpdfname;
    Button uploadBTn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subjectpdflist);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference.child(loc+editpdfname.getText().toString()+"_"+System.currentTimeMillis()).setValue(fileinModel);// push the value into the realtime database
                        Toast.makeText(subjectpdflist.this, "File Uploaded Successfully!!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
...
//        startActivity(new Intent(MainActivity.this, RetrievePDFActivvity.class));
        Toast.makeText(this, "Call for retrieving PDFs", Toast.LENGTH_SHORT).show();
    }
